...
(= (- x1 (- x2 x3)) (f a1 a2  x1 x2 x3))
(= (- x1 (- x3 x2)) (f a1 a2  x1 x2 x3))
(= (- x2 (- x1 x3)) (f a1 a2  x1 x2 x3))
(= (- x2 (- x3 x1)) (f a1 a2  x1 x2 x3))   
(= (- x3 (- x1 x2)) (f a1 a2  x1 x2 x3))
(= (- x3 (- x2 x1)) (f a1 a2  x1 x2 x3))         
)
...
(= (f a1 a2  x1 x2 x3) (f a1 a2 x2 x1 x3))
(or
(= (f a1 a2 x1 x2 x3) (- x2 (- x1 x3)))
(= (f a1 a2 x1 x2 x3) (- x1 (- x2 x3)))
)
