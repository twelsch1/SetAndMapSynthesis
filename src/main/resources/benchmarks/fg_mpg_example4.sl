...
;(>= (plus3 (two-times x) z (minus z1)) (minus y))
;(  <=  ( plus2 x z1 )   y )
;(<= (plus3 x (three-times z) z1) (minus 9))


( constraint (  iteB  (>= (plus3 (* 2 x) z (- 0 z1)) (- 0 y)) 
		         ( iteB  (  <=  ( plus2 x z1 )   y ) 
		  	        (  =  ( eq2 x y z  z1 ) ( plus4  (* 10 x) (* 20  y) (* 15 z) (- 0 99) ) ) 
			        (  =  ( eq2 x y z  z1 ) ( plus3  (* 9 y )  (* 25 z1) (- 0 11) ) ) 
			      )
             ( iteB (<= (plus3 x (* 3 z) z1) (- 0 9))
			      (  =  ( eq2 x y z z1 )  ( plus5 (* 11 x) (* 15 y ) (* 30 z) (* 22 z1 ) 11 ) ) 
			      (  =  ( eq2 x y z z1 )  ( plus4  (* 16 x) ( * 18 z ) (* 5 z1) (- 0 55) ) ) 
			   )
	     ) 
  )   
