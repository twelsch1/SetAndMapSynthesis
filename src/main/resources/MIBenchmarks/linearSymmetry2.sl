...
(iteB (and true  (>= a1 a2) ) (or (= (f a1 a2 x1 x2 x3) (+ (* 10 x1) (+ (* 24 x2) (* 8 x3)))) (= (f a1 a2 x1 x2 x3) (+ (* 10 x2) (+ (* 24 x1) (* 8 x3)))))  (or (= (f a1 a2 x1 x2 x3) (+ (* 11 x1) (+ (* 25 x2) (* 9 x3)))) (= (f a1 a2 x1 x2 x3) (+ (* 11 x2) (+ (* 25 x1) (* 9 x3))))))))
(check-synth)