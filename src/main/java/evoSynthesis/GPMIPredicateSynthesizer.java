...
public class GPMIPredicateSynthesizer extends Synthesizer {
	...
	public GPMIPredicateSynthesizer(String paramFile, Benchmark benchmark) {
		...
		runConfig = new String[] { Evolve.A_FILE, paramFile, 
				...
				"-p", ("variableNamesString=" + variableNamesString), "-p", ("synthType=MIPred"), "-p",
