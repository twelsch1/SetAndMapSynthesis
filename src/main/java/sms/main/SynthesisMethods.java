...
public class SynthesisMethods {
	...
	public static SynthesisResult deterministicSMS(Synthesizer predicateSynthesizer, Benchmark benchmark, 
		...
		String transformedAssertionString = Preprocessor.transformSpecToSingleAssigningInvocation(benchmark);
		benchmark.setAssertionString(transformedAssertionString);
