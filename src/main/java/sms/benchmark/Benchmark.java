...
public class Benchmark {
	...
	private String preTransformAssertionString;
	...
	public String getPreTransformAssertionString() {
		return preTransformAssertionString;
	}

	public void setPreTransformAssertionString(String preTransformAssertionString) {
		this.preTransformAssertionString = preTransformAssertionString;
	}
	...
	//	//System.out.println(funString);
		...
		b.setPreTransformAssertionString(assertionString);
		...
		/*String transformedAssertionString = Preprocessor.transformSpecToSingleAssigningInvocation(b);
		b.setAssertionString(transformedAssertionString);*/
		String transformedAssertionString = Preprocessor.transformToRemoveGteLtes(b);
		b.setAssertionString(transformedAssertionString);
	/*	ArrayList<ArrayList<String>> transformedInvocations = findInvocations(transformedAssertionString,"("+ functionName + " ");
		b.setInvocations(transformedInvocations);*/
		
		/*transformedAssertionString = Preprocessor.transformToJustNeccEqs(b);
		transformedAssertionString = Node.formatProgramStringForNode(transformedAssertionString);
		b.setAssertionString(transformedAssertionString);*/
		
		
		//System.out.println("Um did we remove the GteLtes?");
		//System.out.println(transformedAssertionString);
	/*	transformedAssertionString = Preprocessor.transformToJustEqualsAndDistinctsMI(b);
		b.setAssertionString(transformedAssertionString);
		transformedAssertionString = Preprocessor.transformToJustNecessaryGtLtMI(b);
		b.setAssertionString(transformedAssertionString);
		System.out.println(b.getAssertionString());
		transformedAssertionString = Preprocessor.transformToJustNecessaryComparisons(b);
		b.setAssertionString(transformedAssertionString);
		System.out.println(transformedAssertionString);*/
	...
	public void setInvocations(ArrayList<ArrayList<String>> invocations) {
	...
	private static ArrayList<ArrayList<String>> findInvocations(String assertions, String targetFunction) {
		...
		//	System.out.println("Target Function is " + targetFunction);
		...
		//System.out.println("The string is this: " + principalString);
